                      ...
                      <div className="list-group createGame">
                        ...
                        >
                          <img
                            ...
                            src={require("./img/icons/boots.jpg")}
                          />
                          <br />
                          Sport Centers
                        </a>
                        ...
                        >
                          <img
                            alt="image"
                            className="rounded-circle-create-game"
                            src={require("./img/icons/clock.jpg")}
                          />
                          <br />
                          Game Details
                        </a>
